...
return [
    ...
    */
    ...
    'logo' => '<b>Concesionaria</b>VT',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'ConcesionariaVT',
    ...
    */
    ...
    'menu' => [
        ...
        */
        ...
        ['header' => 'Principales formularios'],
        [
            'text'    => 'Gestión',
            'icon'    => 'fas fa-edit',
            'submenu' => [
                ...
                [
                    'text'    => 'REPMEN',
                    'url'     => '#',
                    'icon'  => 'far fa-circle text-light',
                    'submenu' => [
                        [
                            'text' => 'REPMEN-01',
                            'url'  => '#',
                            'icon'  => 'fas fa-circle text-light',
                        ],
                        [
                            'text' => 'REPMEN-02',
                            'url'  => '#',
