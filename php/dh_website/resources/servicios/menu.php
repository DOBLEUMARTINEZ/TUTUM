    ...
    ?>
		...
		<div class="square-07">
			<ul>
				...
				<li id="proyectos-active" class="service-menu-color" onclick="window.location.href='servicios-fabrica-sw#start';">
	...
	?>
		...
		<div class="square-07">
			<ul>
				...
				<li id="proyectos-active" class="service-menu-color" onclick="window.location.href='servicios-proyectos#start';">
