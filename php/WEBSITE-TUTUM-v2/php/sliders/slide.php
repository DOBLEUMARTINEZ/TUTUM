<div style="position: fixed; height: 100%; width: 100%;">
  ...
  <div class="box-slider">
    ...
    <div id="slider-box-1" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-item ">
          ...
          <table class="table-icons-v1" >
            <tr>
              ...
              <td><img src="images/icons/cable-de-red (2)"></td>
      ...
      <!--  -->
      <a class="carousel-control-prev" href="#slider-box-1" role="button" data-slide="prev" style="width: 5%;">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      </a>

      <a class="carousel-control-next" href="#slider-box-1" role="button" data-slide="next" style="width: 5%;">
