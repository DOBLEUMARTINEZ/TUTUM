<div style="position: relative;">
	...
	<!-- -->
	<img src="<?php echo $url ?>images/img/operacion.jpg" style="position: fixed; width: 100%; z-index: -99">
  	<img src="<?php echo $url ?>images/img/operacion.jpg" style="opacity: 0; width: 100%;">
