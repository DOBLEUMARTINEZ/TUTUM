		...
		<div>
		  	...
		  	<div>
				...
				<ol>	
				  	...
				  	<li>
				  		...
				  		<h3 style="text-align: center; margin: 0;">nuestro</h3>
	  	...
	  	<div>
			<span style="background: url('images/img/FOTO 10.jpg');"></span>
		  	...
		  	<p>
		  		Nuestra herramienta “Remedy Service Desk”, nos permite implementar una mesa de ayuda a nivel Enterprise, la cual es compatible con los procesos de ITIL para el manejo de incidentes, manejo de problemas, brindar niveles de servicios y ordenes de trabajo.
		  	</p>
		  	...
		  	<div>
				...
				<ol>	
				  	...
				  	<li>
				  		...
				  		<h3 style="text-align: center; margin: 0;">ITIL</h3>
				  	</li>
