<div id="modulo-sih-content">
  ...
  <a name="modulos-administrativos"></a>
  <div class="bloque-5">
  ...
  <a name="modulos-clinicos"></a>
  <div class="bloque-6">
    
    <ul style="background: url('images/img/modulos-sih-2.jpg');background-position: center;background-size: cover;">
      <li>
  ...
  <a name="modulos-configuracion"></a>
  <div class="bloque-5">
    ...
    <div>
      ...
      <ol>
        ...
        <li onclick="modalSanet(1, '#modulo-28')"><i class="fas fa-angle-double-right"></i> Importador de datos</li>
        <li onclick="modalSanet(1, '#modulo-29')"><i class="fas fa-angle-double-right"></i> Administración del sistema</li>
        <li onclick="modalSanet(1, '#modulo-30')"><i class="fas fa-angle-double-right"></i> Flujo de trabajo</li>
        <li onclick="modalSanet(1, '#modulo-31')"><i class="fas fa-angle-double-right"></i> Cuestionarios</li>
        <li onclick="modalSanet(1, '#modulo-32')"><i class="fas fa-angle-double-right"></i> Formas</li>
