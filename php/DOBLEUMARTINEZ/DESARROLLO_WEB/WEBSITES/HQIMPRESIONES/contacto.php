...
<head>
  ...
  <title>HQ Impresiones | Contacto</title>
          ...
          <div class="container-contact">
            <div class="row no-gutters">
              ...
              <div class="col-md-7" style="background: #111;">
                <h3>¿Necesitas más información de nuestros servicios?</h3>
              ...
              <div class="col-md-5">
                ...
                <div class="container-end">
                  <ul>
                    <li onclick="window.location.href='tel:5585416183';"> <i  id="rotate" class="fas fa-phone"></i> 55 8541 6183</li>
                    <li onclick="window.location.href='mailto:contacto@hqimpresiones.com.mx';"><i class="fas fa-envelope" ></i> contacto@hqimpresiones.com.mx</li>
                    <li onclick="window.location.href='https://goo.gl/maps/f6hTZf6ZRiv6o1rs9';"><i class="fas fa-map-marker-alt"></i></li>
