		...
		<?php
			...
			if (priv_now=='master') {
				...
				<li style="width: 2.5%; text-align: center;border:none; background-color:<?=$div_color?>;" >
					<p><i onclick="window.location.href='./resources/action.php?origin=<?php echo $_GET['origin'];?>&btn_action=delete_lead&id=<?php echo $row['id']?>';" class="fas fa-trash-alt"></i></p>
				</li>
