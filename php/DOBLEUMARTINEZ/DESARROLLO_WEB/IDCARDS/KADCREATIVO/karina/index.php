...
<head>
  ...
  <meta name="description" content="Kadcreativo | DISEÑO 3D - PUBLICIDAD - MONTAJE">
  ...
  <link href="images/icons/icon-kadcreativo.png" rel="shortcut icon"/>

  <link rel="icon" type="images/icons/icon-kadcreativo.png" sizes="32x32" href="<?php echo $url; ?>/images/icons/icon-kadcreativo.png">

  <link rel="icon" type="images/icons/icon-kadcreativo.png" sizes="16x16" href="<?php echo $url; ?>/images/icons/icon-kadcreativo.png">

  <link rel="manifest" href="<?php echo $url; ?>/images/icons/icon-kadcreativo.png">
  ...
  <!-- description -->
  <meta property="og:title" content="Kadcreativo">
  <meta property="og:description" content="<?php echo $name.'-'.$job; ?>">
  <meta property="og:url" content="<?php echo $url; ?>">
  <meta property="og:type" content="website">
  <meta property="og:locale" content="es_MX">
  <meta property="og:site_name" content="Kadcreativo">
                ...
                <div style="margin: auto;">
                  <h2 id="descserv-1">
                    ...
                    <ol class="descserv descserv-1">
                      <li><i class="fas fa-angle-double-right"></i> Páginas web</li> 
                  ...
                  <h2 id="descserv-2">
                    ...
                    <ol class="descserv descserv-2">
                      ...
                      <li><i class="fas fa-angle-double-right"></i> Logotipos</li>
                      <li><button onclick="window.location.href='https://wa.me/<?php echo $phone_2;?>';" >COTIZA AHORA </button></li>
                    </ol>
                  </h2>
                  ...
                  <h2 id="descserv-3">
                   CREACIÓN DE CONTENIDO
                    <ol class="descserv descserv-3">
                      <li><i class="fas fa-angle-double-right"></i> Estrategias digitales </li> 
                      <li><i class="fas fa-angle-double-right"></i> Seguimiento de cuentas y redes sociales</li>
                      <li><i class="fas fa-angle-double-right"></i> Planeación de mercadotecnia</li>
                      <li><i class="fas fa-angle-double-right"></i> Crecimiento orgánico y pagado</li>
                      <li><button onclick="window.location.href='https://wa.me/<?php echo $phone_2;?>';" >COTIZA AHORA </button></li>
                    </ol>
                  </h2>
                  ...
                  <h2 id="descserv-4">
                    ...
                    <ol class="descserv descserv-4">
                      ...
                      <li><i class="fas fa-angle-double-right"></i> Publicidad impresa</li>
                      <li><i class="fas fa-angle-double-right"></i> Producción y fabricación de stands</li>
                      <li><button onclick="window.location.href='https://wa.me/<?php echo $phone_2;?>';" >COTIZA AHORA </button></li>
                    </ol>
                  </h2>
