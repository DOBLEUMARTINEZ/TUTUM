...
<head>
  ...
  <meta name="description" content="ISSU | DISEÑO 3D - PUBLICIDAD - MONTAJE">
  ...
  <link href="images/icons/icon-ISSU.png" rel="shortcut icon"/>

  <link rel="icon" type="images/icons/icon-ISSU.png" sizes="32x32" href="<?php echo $url; ?>/images/icons/icon-ISSU.png">

  <link rel="icon" type="images/icons/icon-ISSU.png" sizes="16x16" href="<?php echo $url; ?>/images/icons/icon-ISSU.png">

  <link rel="manifest" href="<?php echo $url; ?>/images/icons/icon-ISSU.png">
                  ...
                  <h2 id="descserv-2">
                   MONTAJE DE STANDS
                    <ol class="descserv descserv-2">
                      <li><i class="fas fa-angle-double-right"></i> Innovar nos inspira a brindar a nuestros clientes una experiencia única, cumpliendo cada una de las ideas y expectativas  de nuestros socios de negocio.</li>
                      <li><button onclick="window.location.href='https://wa.me/<?php echo $phone_2;?>';" >COTIZA AHORA </button></li>
                    </ol>
                  </h2>
                  ...
                  <h2 id="descserv-3">
                   PUBLICIDAD
                    <ol class="descserv descserv-3">
                      <li><i class="fas fa-angle-double-right"></i> Letreros luminosos/ Acrílico/Aluminio </li> 
                      <li><i class="fas fa-angle-double-right"></i> Corte CNC</li>
                      <li><i class="fas fa-angle-double-right"></i> Logotipos</li>
                      <li><i class="fas fa-angle-double-right"></i> Impresiones</li>
