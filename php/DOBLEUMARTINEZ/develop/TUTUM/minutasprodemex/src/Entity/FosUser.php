...
class FosUser
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="initials", type="string", length=25, nullable=true)
     */
    private $initials;
     ...
     * @var bool
     *
     * @ORM\Column(name="new_password", type="boolean", nullable=false)
     */
    private $newPassword = '0';
    ...
    public function setNewPassword(bool $newPassword): self
    {
