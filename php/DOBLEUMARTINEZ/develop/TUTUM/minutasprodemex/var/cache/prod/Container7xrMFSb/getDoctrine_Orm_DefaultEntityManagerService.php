...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\AudienciaRepository' => ['privates', 'App\\Repository\\AudienciaRepository', 'getAudienciaRepositoryService', true],
            'App\\Repository\\CategoriaRepository' => ['privates', 'App\\Repository\\CategoriaRepository', 'getCategoriaRepositoryService', true],
            'App\\Repository\\EstatusMinutaRepository' => ['privates', 'App\\Repository\\EstatusMinutaRepository', 'getEstatusMinutaRepositoryService', true],
            'App\\Repository\\LogRepository' => ['privates', 'App\\Repository\\LogRepository', 'getLogRepositoryService', true],
            'App\\Repository\\MinutaRepository' => ['privates', 'App\\Repository\\MinutaRepository', 'getMinutaRepositoryService', true],
            'App\\Repository\\RegistroMinutaRepository' => ['privates', 'App\\Repository\\RegistroMinutaRepository', 'getRegistroMinutaRepositoryService', true],
            'App\\Repository\\SeccionMinutaRepository' => ['privates', 'App\\Repository\\SeccionMinutaRepository', 'getSeccionMinutaRepositoryService', true],
            'App\\Repository\\TemaMinutaRepository' => ['privates', 'App\\Repository\\TemaMinutaRepository', 'getTemaMinutaRepositoryService', true],
            'App\\Repository\\TemaUsuarioRepository' => ['privates', 'App\\Repository\\TemaUsuarioRepository', 'getTemaUsuarioRepositoryService', true],
            'App\\Repository\\UsuarioRepository' => ['privates', 'App\\Repository\\UsuarioRepository', 'getUsuarioRepositoryService', true],
        ], [
            'App\\Repository\\AudienciaRepository' => '?',
            'App\\Repository\\CategoriaRepository' => '?',
            'App\\Repository\\EstatusMinutaRepository' => '?',
            'App\\Repository\\LogRepository' => '?',
            'App\\Repository\\MinutaRepository' => '?',
            'App\\Repository\\RegistroMinutaRepository' => '?',
            'App\\Repository\\SeccionMinutaRepository' => '?',
            'App\\Repository\\TemaMinutaRepository' => '?',
            'App\\Repository\\TemaUsuarioRepository' => '?',
