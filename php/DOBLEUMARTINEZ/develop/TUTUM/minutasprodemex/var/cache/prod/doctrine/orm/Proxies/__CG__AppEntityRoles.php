...
class Roles extends \App\Entity\Roles implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Roles' . "\0" . 'idRoles', '' . "\0" . 'App\\Entity\\Roles' . "\0" . 'rol', '' . "\0" . 'App\\Entity\\Roles' . "\0" . 'nivel', '' . "\0" . 'App\\Entity\\Roles' . "\0" . 'color'];
        }
    ...
    public function getIdRoles(): ?int
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdRoles();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdRoles', []);
     ...
     * {@inheritDoc}
     */
    public function setRol(string $rol): \App\Entity\Roles
    {
     ...
     * {@inheritDoc}
     */
    public function setNivel(int $nivel): \App\Entity\Roles
    {
     ...
     * {@inheritDoc}
     */
    public function setColor(?int $color): \App\Entity\Roles
    {
