...
<div class="box-banner-index">
  ...
  <span class="mouse-icon" onclick="window.location.href='#dolorfin';">
  	 <img class="updown" src="<?php echo $url; ?>resources/images/mouse-cursor.png" title="Dolorfin" alt="icono de raton de computadora color azul png">
  </span>
...
<div class="bloque-1">
	...
	<ul>
		<li onclick="window.location.href='#proceso-dolorfin';">
			<img src="<?php echo $url; ?>resources/images/Quiropractica.png" title="Dolorfin" alt="Expertos en eliminar el dolor de espalda, cabeza y más">
		    <h3>Quiropráctica</h3>
		</li>
		<li onclick="window.location.href='#proceso-dolorfin';">
			<img src="<?php echo $url; ?>resources/images/Fisioterapia.png" title="Dolorfin" alt="Expertos en eliminar el dolor de espalda, cabeza y más">
		    <h3>Fisioterapia</h3>
		</li>
		<li onclick="window.location.href='#proceso-dolorfin';">
			<img src="<?php echo $url; ?>resources/images/Masaje-Terapeutico.png" title="Dolorfin" alt="Expertos en eliminar el dolor de espalda, cabeza y más">
