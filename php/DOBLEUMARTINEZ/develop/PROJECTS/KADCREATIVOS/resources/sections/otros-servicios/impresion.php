...
<div class="box-services-2" >
	<div>
		<h2>
			Impresión digital, offset tradicional, en gran formato, recorte de vinil, sublimación y serigrafía.
		</h2>
	...
	<div style="display: flex;justify-content: center;">
		<ol class="gallery-wm">
			<li class="img-1" style="background-image: url('./resources/images/impresion-1.jpg');"><span>1</span></li>
			<li class="img-2" style="background-image: url('./resources/images/impresion-2.jpg');"><span>2</span></li>
		</ol>
	</div>
</div>
