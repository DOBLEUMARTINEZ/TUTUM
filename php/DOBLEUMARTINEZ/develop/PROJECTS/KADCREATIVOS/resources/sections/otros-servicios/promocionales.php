...
<div class="box-services-2" >
	<div>
		<h2>
			Personalizamos y te damos el promocional perfecto para tu marca.
			<br>-Playeras
			<br>-Tazas
			<br>-Agendas
			<br>-Plumas
	...
	<div style="display: flex;justify-content: center;">
		<ol class="gallery-wm">
			<li class="img-1" style="background-image: url('./resources/images/promo-1.jpg');"><span>1</span></li>
			<li class="img-2" style="background-image: url('./resources/images/promo-2.jpg');"><span>2</span></li>
			<li class="img-3" style="background-image: url('./resources/images/promo-3.jpg');"><span>3</span></li>
		</ol>
	</div>
</div>
