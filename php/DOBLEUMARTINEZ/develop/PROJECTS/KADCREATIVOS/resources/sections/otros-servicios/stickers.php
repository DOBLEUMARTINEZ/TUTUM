	  	...
	  	<div class="carousel-inner">
		    <div class="carousel-item active breadcrum-content">
		      	...
		      	<h1>
		      		...
		      		<a href="<?php echo $url;?>stickers">stickers</a> 
		      	</h1>
		    </div>
	  	</div>
	</div>
...
<div class="box-services-second">
	<h2>
		Personalizamos e imprimimos stickers
	</h2>
	<div>
		<div>
			...
			<ol>
				<li>Sobre vinil</li>
				<li>Con o sin suaje</li>
				<li>Color solido o transparente</li>
			</ol>
		...
		<div class="slide-center-jm">
			<div id="carouselExampleControls-2" class="carousel slide" data-ride="carousel">
			  	...
			  	<div class="carousel-inner">
				    ...
				    <div class="carousel-item">
				      	<img class="d-block w-100" src="./resources/images/stickers-3.jpg" title="Foto y video" alt="Foto y video" onclick="window.location.href='<?php echo $url?>foto-y-video';">
				    </div>

				    <div class="carousel-item">
				      	<img class="d-block w-100" src="./resources/images/stickers-4.jpg" title="Foto y video" alt="Foto y video" onclick="window.location.href='<?php echo $url?>foto-y-video';">
				    </div>
