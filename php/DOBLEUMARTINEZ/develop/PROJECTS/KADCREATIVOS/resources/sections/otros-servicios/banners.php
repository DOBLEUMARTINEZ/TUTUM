...
<div class="box-services-2" >
	...
	<div style="display: flex;justify-content: center;">
		<ol class="gallery-wm">
			<li class="img-1" style="background-image: url('./resources/images/banners-1.jpg');"><span>1</span></li>
			<li class="img-2" style="background-image: url('./resources/images/banners-2.jpg');"><span>2</span></li>
			<li class="img-3" style="background-image: url('./resources/images/banners-3.jpg');"><span>3</span></li>
			<li class="img-4" style="background-image: url('./resources/images/banners-4.jpg');"><span>4</span></li>
		</ol>
	</div>
</div>
