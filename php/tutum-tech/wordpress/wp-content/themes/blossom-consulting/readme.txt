...
== Changelog ==  
    ...
    1.0.9 - September 22, 2021
        * Fixed: Design fixes for link
        * Fixed: Dynamic root variable
	
    1.0.8 - July 07, 2020
        * Modified: demo link

    1.0.7 - February 13, 2020
        * Fixed: responsive design issues
    
    1.0.6 - January 24, 2020
        * Fixed: Banner section responsive issue

    1.0.5 - December 16, 2019
        * Fixed: Static/Video CTA banner issue
    ...
    * made support for fontawesome update of 5.0
