...
MetaSoft includes support for Infinite Scroll in Jetpack and other following Plugins.
1. Clever Fox

-------------------------------------------------------------------------------------------------
License and Copyrights for Resources used in MetaSoft WordPress Theme
-------------------------------------------------------------------------------------------------
...
=================================================================================================
Screenshot Images
URL: https://pxhere.com/en/photo/1629587
...
@version 1.0.40
*Add Widget Meta WordPress Icon
...
@version 1.0.35
*Fixed Footer Widget Block Social Style Issue

@version 1.0.34
*Fixed Footer Widget Block Calendar Caption Color Issue

@version 1.0.33
*Fixed Footer Widget Block Calendar Active Date Color Issue

@version 1.0.32
*Fixed Block Logout

@version 1.0.31
*Fixed Block Recent Widget Comments Padding Issue
...
@version 1.0.28
*Fixed Block Widget Padding Issue
...
@version 1.0.25
* Fixed Sidebar Widget Block Calendar Caption Align Issue

@version 1.0.24
* Fixed Sidebar Widget Product Button Color Issue

@version 1.0.23
* Fixed Block Table Style Issue

@version 1.0.22
* Tested with WordPress 5.8.1

@version 1.0.21
*Fixed Block Calendar Margin Issue

@version 1.0.20
*Fixed Info Button Issue in Mobile
...
@version 1.0.17
* Fixed Widget Block Search Button Padding Issue

@version 1.0.16
* Sidebar Widget Block Search Button Color Issue Fixed
...
@version 1.0.13
* Calendar Widget Activate Date Color Issue Fixed in Footer
