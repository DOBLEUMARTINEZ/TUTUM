...
<div class="square-06">
	...
	<ol>
		<li>
			...
			<p>
				Contamos con experiencia ofreciendo <strong>servicios de mesa de ayuda</strong> para proyectos en seguridad hospitalaria y corporativa, teniendo como objetivo el asegurar la continua operación de los sistemas de nuestros clientes.​
			</p>
...
<div class="square-04">
	<ol  style="padding-bottom: 5%;">
		...
		<li>
			<p>
				Ofrecemos nuestros servicios de mesa de ayuda garantizando la correcta operación de los sistemas de nuestros clientes, ofreciendo servicios profesionales y de la más alta calidad, teniendo como prioridad la atención a los servicios de nuestros clientes.
			</p>
		</li>
	</ol>
</div>
...
<div class="square-12" style="background: #000;" >
	...
	<ol class="box-icon-type-2" >
		...
		<li>
			<br><br>
			<img src="images/icons/services/cau/mantenimiento.png"><br><br>
			<p style="color: #fff;" >Mantenimientos ​reventivos</p>
			<br><br>
		</li>
		<li>
			<br><br>
