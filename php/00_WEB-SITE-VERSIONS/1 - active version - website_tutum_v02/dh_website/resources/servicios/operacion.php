...
<div class="square-11">
	<ul>
		<li>
			<p>Atención a Usuarios ​24/7</p>
			<img src="images/icons/cau.png" >
		</li>
		<li>
			<img src="images/icons/team-2.png" >
			<p><span>+250</span><br>Especialistas</p>
		</li>
		<li>
			<p>Servicios​ Administrados por nuestro CAU</p>
...
<div class="square-06">
	...
	<ol>
		<li>
			...
			<p>
				Contamos con experiencia en la operación de proyectos en seguridad hospitalaria y corporativa, teniendo como objetivo el asegurar la continua operación de los sistemas de nuestros clientes.
			</p>
		...
		<li style="background: url('<?php echo $url ?>images/img/operacion-1.jpg');background-position: center;background-size: 100%;border-bottom: 1.5vw solid #fff;border-top: 1.5vw solid #fff;"></li>
	</ol>
</div>
