...
<div class="square-10">
  <ul>
    ...
    <li style="position: relative;">
      ...
      <h3>+10K</h3>
      <p class="circle-info-ide" >EQUIPOS DE CÓMPUTO IMPRESIÓN Y TELEFONÍA​</p>
    </li>
    <li style="position: relative;">
...
<div class="square-04">
	<ol style="background: #fff;">
		...
		<li>
			<p>
				Somos partners de los principales fabricantes de software y hardware de servicios de tecnologías de la información a nivel mundial y colaboramos con un creciente número de nuevas compañías especialistas en soluciones y servicios de TI, trasladando a nuestros clientes el valor diferencial que nos permite desarrollar sus proyectos con calidad.
			</p>
		</li>
	</ol>
</div>
