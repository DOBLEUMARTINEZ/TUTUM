<div id="licencias-content">
  ...
  <div class="bloque-2" style="background: url('images/img/modulos-sih-2.jpg');background-position: center;background-size: cover;">
    <h2>Soporte especializado para hacer de su<br> experiencia la mejor posible</h2>
  </div>

  <div class="bloque-3">
    <h2>Modelos de licenciamiento</h2>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          Se contará con alta disponibilidad en todo momento, seguridad del más alto nivel y actualizaciones periódicas, teniendo en todo momento <span>sanet</span> actualizado y a la vanguardia.
        </p>
      ...
      <li>
        ...
        <p>
          Las actualizaciones y mantenimiento del software se coordinarán con el personal de sistemas del hospital para no afectar a la operación.
        </p>
       <button onclick="window.location.href='./contacto';">¡Comenzar ahora!</button>
      </li>
...
<div id="quienes-somos-content">
  <div class="bloque-2">
    <h2>Se ajusta a tus necesidades</h2>
    <ol>
      <li>
      ...
      <li>
        <img src="images/icons/licencias/hospitales-2.png" title="Pasión" alt="Icono de Pasion - Apreton de Manos PNG de colores">
        <h3>Hospitales Medianos</h3>
      </li>
      <li>
        <img src="images/icons/licencias/clinica.png" title="Disciplina" alt="Icono de Disiplina - Calendario PNG de colores">
        <h3>Hospitales Pequeños y Clínicas</h3>
      </li>
    </ol>
  </div>
...
<div id="modulo-index-content">
  ...
  <div class="bloque-4" style="padding-top: 0%;">
    <div>
